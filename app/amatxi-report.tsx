...
export function AmatxiReport({ records, bitcoinEur, loading }: { records: GiftRecord[]; bitcoinEur: number | null; loading: boolean }) {
  ...
  const explanationRef = useDialogA11y(explanationOpen, () => setExplanationOpen(false));

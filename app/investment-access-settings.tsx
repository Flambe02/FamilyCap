  ...
  return <section className="investment-access-settings">
    ...
    {!access ? <p className="info-callout">Chargement des droits de partage...</p> : <>
      <fieldset className="investment-access-options"><legend>Qui peut voir mes investissements ?</legend>
        <label className={access.scope === "family" ? "selected" : ""}><input type="radio" name="investment-access" checked={access.scope === "family"} onChange={() => setScope("family")} /><span><b>Toute la famille active</b><small>Tous les utilisateurs actifs de LaBaJo & Co peuvent consulter tes investissements.</small></span></label>

...
export function AdminUsers() {
  ...
  async function saveUser(event: FormEvent<HTMLFormElement>, user: FamilyUser) {
    ...
    try {
      await request("/api/admin/users", { method: "PATCH", body: JSON.stringify({ id: user.id, name: draft.name, email: draft.email, role: draft.role, birthday: draft.birthday, accessScope: draft.accessScope, selectedViewerIds: draft.selectedViewerIds, walletAddress: draft.walletAddress }) }, "Modification impossible");

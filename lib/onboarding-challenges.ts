...
export const ONBOARDING_MISSIONS: readonly OnboardingMissionDef[] = [
  {
    ...
    successMessage: "Ton compte est prêt ! +50 points",
  },
  {
    ...
    view: "investissements-pea",
    successMessage: "Ton portefeuille prend forme ! +100 points",
  },
  {
  ...
  },
  {
    ...
    view: "investissements-pea",
    successMessage: "Premier investissement enregistré ! +150 points",
  },
] as const;
